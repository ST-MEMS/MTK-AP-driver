...
static ssize_t lps22hh_attr_i2c_show_reg_value(struct device_driver *ddri, char *buf)
{
...
static ssize_t lps22hh_attr_i2c_store_reg_value(struct device_driver *ddri, const char *buf, size_t count)
{
    struct lps22hh_data *obj = obj_i2c_data;
...
static ssize_t lps22hh_attr_baro_show_reg_addr(struct device_driver *ddri, char *buf)
{
    struct lps22hh_data *obj = obj_i2c_data;
...
static ssize_t lps22hh_attr_i2c_store_reg_addr(struct device_driver *ddri, const char *buf, size_t count)
{
    struct lps22hh_data *obj = obj_i2c_data;
	u8 reg_addr;
